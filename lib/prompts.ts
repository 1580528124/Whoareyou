...
3. 第三优先级：玩家发言是否能和已经出现的AI线索形成合理关系
...
13. 只有玩家发言和核心词几乎没有关系，或只是“能吃、能用、挺常见”这种无对象常识，才可以让3个AI全部识破

请分别模拟这3个AI评审独立判断：
1. ${aiNames[0]}：内容审查员，重点看玩家发言的内容方向是否贴近核心词
2. ${aiNames[1]}：线索审查员，重点看玩家发言是否能和已出现AI线索或核心词本身形成合理关系
